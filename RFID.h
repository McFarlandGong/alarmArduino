 ...
 * Definitions
 ******************************************************************************/
#define MAX_LEN 16   // Largo mimo de la matriz

//MF522 comando palabra
#define PCD_IDLE              0x00               // NO action; Y cancelar el comando
#define PCD_AUTHENT           0x0E               // autenticaci de clave
#define PCD_RECEIVE           0x08               // recepci de datos
...
#define PICC_REQIDL           0x26               // ea de la antena no est?tratando de entrar en el estado de reposo
#define PICC_REQALL           0x52               // Todas las cartas para encontrar ea de la antena
#define PICC_ANTICOLL         0x93               // anti-colisi
#define PICC_SElECTTAG        0x93               // elecci de tarjeta
#define PICC_AUTHENT1A        0x60               // verificaci髇 key A
#define PICC_AUTHENT1B        0x61               // verificaci髇 Key B
...
#define PICC_TRANSFER         0xB0               // Guardar los datos en el b鷉er
#define PICC_HALT             0x50               // inactividad

//MF522 C骴igo de error de comunicaci髇 cuando regres?#define MI_OK                 0
